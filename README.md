...
await producer.produce({
    message: '<bytes array>/protobuf object/object/string/DocumentNode graphql', // Uint8Arrays/protobuf object (schema validated station - protobuf) or Uint8Arrays/object (schema validated station - json schema) or Uint8Arrays/string/DocumentNode graphql (schema validated station - graphql schema)
