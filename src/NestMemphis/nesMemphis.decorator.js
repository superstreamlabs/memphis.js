...
var memphis_1 = require("../memphis");
var createConsumer = function (_a) {
    ...
    return function (target, propertyKey, descriptor) {
        var memphisConnection;
        var originalDescriptor = descriptor.value;
        descriptor.value = function () {
            return __awaiter(this, void 0, void 0, function () {
                var consumer, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            console.log('this object is the one calling it', originalDescriptor);
                            _a.label = 1;
                        case 1:
                            _a.trys.push([1, 4, , 5]);
                            return [4 /*yield*/, originalDescriptor()];
                        case 2:
                            memphisConnection = _a.sent();
                            ...
                            return [4 /*yield*/, memphisConnection.consumer({
