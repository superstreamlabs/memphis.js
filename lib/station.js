        ...
        try {
            ...
            if (isBuffer) {
                try {
                    ...
                    throw errors_1.MemphisErrors.ExpectingJSONFormat(ex);
                }
                msgToSend = msg;
                ...
                throw errors_1.MemphisErrors.UnsupportedMessageType;
            }
        }
        catch (ex) {
            throw errors_1.MemphisErrors.FailedSchemaValidation(ex.message);
        }
    }
        ...
        try {
            ...
            if (isBuffer) {
                try {
                    ...
                    throw errors_1.MemphisErrors.ExpectingAVROFormat(ex);
                }
                msgToSend = msg;
                ...
                if (!valid) {
                    throw errors_1.MemphisErrors.FailedSchemaValidation(type);
                }
                return msgToSend;
            }
            else if (Object.prototype.toString.call(msg) == '[object Object]') {
    ...
    _validateProtobufMessage(msg) {
        ...
        if (meassageDescriptor) {
            if (msg instanceof Uint8Array) {
                ...
                if (errMsg) {
                    throw errors_1.MemphisErrors.FailedSchemaValidation(errMsg);
                }
    ...
    _validateGraphqlMessage(msg) {
        try {
            ...
            if (validateRes.length > 0) {
                throw errors_1.MemphisErrors.FailedSchemaValidation(validateRes);
            }
            return msgToSend;
        }
        catch (ex) {
