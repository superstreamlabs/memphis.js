...
class Memphis {
    ...
    async station({ name, retentionType = retentionTypes.MAX_MESSAGE_AGE_SECONDS, retentionValue = 604800, storageType = storageTypes.DISK, replicas = 1, idempotencyWindowMs = 120000 }) {
        var _a;
        try {
                ...
                case 'protobuf':
                    ...
                    if (meassageDescriptor) {
                        if (msg instanceof Uint8Array) {
                            ...
                            if (errMsg) {
                                this.connection.sendNotification('Schema validation has failed', `Station: ${this.stationName}\nProducer: ${this.producerName}\nError: ${errMsg}`, JSON.stringify(msg), schemaVFailAlertType);
                            ...
                            this.connection.sendNotification('Schema validation has failed', `\nStation: ${this.stationName}\nProducer: ${this.producerName}\nError: Unsupported message type`, JSON.stringify(msg), schemaVFailAlertType);
