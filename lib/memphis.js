...
class Memphis {
    ...
    connect({ host, port = 6666, username, accountId = 1, connectionToken = '', password = '', reconnect = true, maxReconnect = 3, reconnectIntervalMs = 5000, timeoutMs = 2000, keyFile = '', certFile = '', caFile = '' }) {
    ...
    async _getTenantName(accountId) {
        try {
            ...
            if (teanatNameResp['error'] != '') {
                throw (0, utils_1.MemphisError)(new Error(teanatNameResp['error']));
            }
    ...
    close() {
        ...
        setTimeout(async () => {
            var _a, _b;
            await ((_b = (_a = this.brokerManager) === null || _a === void 0 ? void 0 : _a.close) === null || _b === void 0 ? void 0 : _b.call(_a));
        }, 500);
        this.consumeHandlers = [];
        this.producersMap = new Map();
        this.consumersMap = new Map();
