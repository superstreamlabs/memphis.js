...
class Memphis {
    ...
    async consumer({ stationName, consumerName, consumerGroup = '', pullIntervalMs = 1000, batchSize = 10, batchMaxTimeToWaitMs = 5000, maxAckTimeMs = 30000, maxMsgDeliveries = 2, genUniqueSuffix = false, startConsumeFromSequence = 1, lastMessages = -1, consumerPartitionKey = null, consumerPartitionNumber = -1, }) {
        var _a;
        try {
            if (!this.isConnectionActive)
                throw new Error('Connection is dead');
