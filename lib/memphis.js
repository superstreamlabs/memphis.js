...
class Producer {
    ...
    async produce({ message, ackWaitSec = 15, asyncProduce = false }) {
        try {
            ...
            if (asyncProduce)
                this.connection.brokerConnection.publish(`${subject}.final`, message, { msgID: (0, uuid_1.v4)(), headers: h, ackWait: ackWaitSec * 1000 * 1000000 });
            else
