...
class Memphis {
    ...
    async _sdkClientUpdatesListener() {
        ...
        try {
            ...
            try {
                for (var sub_3 = __asyncValues(sub), sub_3_1; sub_3_1 = await sub_3.next(), !sub_3_1.done;) {
                    const m = sub_3_1.value;
                ...
                try {
                    if (sub_3_1 && !sub_3_1.done && (_a = sub_3.return)) await _a.call(sub_3);
                }
