...
class Consumer {
    constructor(connection, stationName, consumerName, consumerGroup, pullIntervalMs, batchSize, batchMaxTimeToWaitMs, maxAckTimeMs, maxMsgDeliveries, startConsumeFromSequence, lastMessages, realName, partitions) {
        ...
        try {
            ...
            try {
                for (var batch_1 = __asyncValues(batch), batch_1_1; batch_1_1 = await batch_1.next(), !batch_1_1.done;) {
                    ...
                    messages.push(new message_1.Message(m, this.connection, this.consumerGroup, this.stationName));
                }
            }
        ...
        try {
            for (var iter_1 = __asyncValues(iter), iter_1_1; iter_1_1 = await iter_1.next(), !iter_1_1.done;) {
                ...
                if (isDls) {
                    ...
                    this.dlsMessages[indexToInsert] = new message_1.Message(m, this.connection, this.consumerGroup, this.stationName);
                    this.dlsCurrentIndex++;
                }
                this.eventEmitter.emit('message', new message_1.Message(m, this.connection, this.consumerGroup, this.stationName), this.context);
            }
        }
