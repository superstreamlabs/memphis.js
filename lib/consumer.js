...
class Consumer {
    constructor(connection, stationName, consumerName, consumerGroup, pullIntervalMs, batchSize, batchMaxTimeToWaitMs, maxAckTimeMs, maxMsgDeliveries, startConsumeFromSequence, lastMessages, realName) {
    ...
    async fetch({ batchSize = 10 }) {
        ...
        try {
            ...
            const batch = await this.connection.brokerConnection.fetch(this.internalStationName, durableName, { batch: batchSize, expires: this.batchMaxTimeToWaitMs });
            try {
