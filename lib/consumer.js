...
class Consumer {
    ...
    async fetch({ batchSize = 10, consumerPartitionKey = null, consumerPartitionNumber = -1 }) {
        ...
        try {
            ...
            const fetchOpts = { max_messages: batchSize, expires: this.batchMaxTimeToWaitMs };
            ...
            try {
                for (var _d = true, batch_1 = __asyncValues(batch), batch_1_1; batch_1_1 = await batch_1.next(), _a = batch_1_1.done, !_a;) {
                    ...
                    try {
                        const m = _c;
                        messages.push(new message_1.Message(m, this.connection, this.consumerGroup, this.internalStationName, messagePartitionNumber));
                    }
                    finally {
                        _d = true;
                    }
            ...
            for (var _d = true, iter_1 = __asyncValues(iter), iter_1_1; iter_1_1 = await iter_1.next(), _a = iter_1_1.done, !_a;) {
                ...
                try {
                    ...
                    if (isDls) {
                        ...
                        this.dlsMessages[indexToInsert] = new message_1.Message(m, this.connection, this.consumerGroup, this.internalStationName, DlsMessagePartitionNumber);
